...
(* OASIS_START *)
(* DO NOT EDIT (digest: 38f150f7b8afc09d7090a9edb6599364) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "SQLite3 over RAFT + peer discovery";
          description = None;
          categories = [];
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("llnet", None);
                           FindlibPackage ("oraft", None);
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "llsqlite.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\136\168\127\189_\130\021\129\190B)\236j\135X\004";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
